...
import 'package:restaurantapps/provider/detail_restaurant_provider.dart';
    ...
    return Scaffold(
      body: ChangeNotifierProvider<DetailRestaurantProvider>(
        create: (_) => DetailRestaurantProvider(
            apiDetail: ApiDetail(idDetail: restaurant.id)),
        child: DetailMenu(),
      ),
    );
  }
                    ...
                    onPressed: () {
                      showDialog<String>(
                        ...
                        builder: (BuildContext context) => AlertDialog(
                          ...
                          content: const Text('Apakah anda ingin menambahkan resto ke favorit?'),
                          actions: <Widget>[
                            TextButton(
